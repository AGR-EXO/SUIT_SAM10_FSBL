...
bool PCA9957HNMP_WriteReg(uint8_t reg, uint8_t data)
{
	...
	if(pca9957hnmp_callback.pca9957hnmp_spi_op((write_reg & 0xFE), data, dummy_packet, 50, SPI_TRANSMIT) != true)
		ret = false;

	pca9957hnmp_callback.pca9957hnmp_delay(1);
...
//	if(pca9957hnmp_callback.pca9957hnmp_spi_op((read_reg | 0x01), 0xff, rxdata, 50, SPI_TRANSMIT_DMA) != true)
	if(pca9957hnmp_callback.pca9957hnmp_spi_op((read_reg | 0x01), 0xff, rxdata, 50, SPI_TRANSMIT) != true)
		ret = false;
	...
	if(pca9957hnmp_callback.pca9957hnmp_spi_op(0xff, 0xff, rxdata, 50, SPI_TRANSMIT_RECEIVE) != true)
		ret = false;
...
bool PCA9957HNMP_RegisterCallback(PCA9957HNMP_CallbackStruct* led24ch_callback)
{
	...
	if(!led24ch_callback->pca9957hnmp_nOE_ctrl || !led24ch_callback->pca9957hnmp_nRST_ctrl|| !led24ch_callback->pca9957hnmp_spi_op || !led24ch_callback->pca9957hnmp_delay)
		return false;
	...
	pca9957hnmp_callback.pca9957hnmp_delay     = led24ch_callback->pca9957hnmp_delay;
